...
const dataAbout = {
  title: "نبذة عن السوق",
  paragraphs: [
   " يقدم سوق العدد الصناعية خدمات بيع متكاملة في مكان واحد",
    "ويهدف السوق لتقديم كل ما يخدم العملاء من حيث الجوده والسعر للعدد الصناعية.",
"مما يجعل السوق وجهة آمنة تلبي جميع احتياجات القطاع الصناعي المتنوع."  ],
  features: [
